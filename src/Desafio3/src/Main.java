...
public class Main {
    public static void main(String[] args) {
        ...
        while(jogador.estaVivo() && inimigo.estaVivo()){
            System.out.println(jogador.getClasse() + " (" + jogador.getNome() + ") vida: " + jogador.getVida());
            System.out.println(inimigo.getClasse()+ " (" + inimigo.getNome() + ") Vida: " + inimigo.getVida());
       ...
       while(true) {
           ...
           if (escolha== 1) {
            ...
            if (!inimigo.estaVivo()){
                System.out.println(inimigo.getClasse() + " morreu!");
                System.out.println(jogador.getClasse() + " venceu!");
                break;
            }
            ...
            if (!jogador.estaVivo()){
                System.out.println(jogador.getClasse() + " morreu!");
                System.out.println(inimigo.getClasse() + " venceu!");
            }
